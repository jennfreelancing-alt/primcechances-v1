                            ...
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                <AnimatedGroup variants={transitionVariants}>
                                    <div className="hover:bg-background dark:hover:border-t-border bg-muted group mx-auto flex w-fit items-center gap-4 rounded-full border p-1 pl-4 shadow-md shadow-black/5 transition-all duration-300 dark:border-t-white/5 dark:shadow-zinc-950">
                                        <span className="text-foreground text-sm">Discover Global Opportunities</span>
                                    ...
                                    <p className="mx-auto mt-8 max-w-2xl text-balance text-lg">
                                        Discover jobs, scholarships, fellowships, and grants from leading organizations worldwide. AI-powered matching to help you find the perfect opportunity.
                                    </p>
                                </AnimatedGroup>
...
const OpportunityButton = () => {
    ...
    return (
        <Button
            ...
            <span className="text-nowrap">Explore Opportunities</span>
        </Button>
    )
}
