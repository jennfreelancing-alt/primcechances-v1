 ...
 * Sends emails automatically via Supabase Edge Function (no manual scripts)
 */
...
export const sendAutomaticEmail = async (
  ...
  try {
    console.log('🚀 Sending automatic email via edge function...');
...
export const sendAutomaticWelcomeEmail = async (data: {
  userName: string;
  userEmail: string;
  loginUrl: string;
}) => {
...
export const sendAutomaticPasswordResetEmail = async (data: {
  userName: string;
  userEmail: string;
  resetUrl: string;
  expiresIn: string;
...
export const sendAutomaticApplicationConfirmationEmail = async (data: {
  userName: string;
  userEmail: string;
