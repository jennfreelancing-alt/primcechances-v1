/**
 * Simple Automatic Email Service
 * Sends emails automatically via Supabase Edge Function (no manual Node scripts)
 */
...
// Function to send email automatically using Supabase Edge Function
export const sendSimpleAutomaticEmail = async (
  emailData: EmailData
): Promise<{ success: boolean; error?: string; messageId?: string }> => {
  try {
    console.log('🚀 Sending simple automatic email via edge function...');
    ...
    console.error('❌ Simple automatic email error:', error);
    return {
      success: false,
...
export const sendSimpleAutomaticWelcomeEmail = async (data: {
  userName: string;
  userEmail: string;
  loginUrl: string;
}) => {
...
<body>
  ...
  return sendSimpleAutomaticEmail({
    to: data.userEmail,
...
export const sendSimpleAutomaticPasswordResetEmail = async (data: {
  userName: string;
  userEmail: string;
  resetUrl: string;
  expiresIn: string;
...
export const sendSimpleAutomaticApplicationConfirmationEmail = async (data: {
  userName: string;
  userEmail: string;
